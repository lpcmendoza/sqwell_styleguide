        ...
        <>
            ...
            <div className={styles.descriptionContainer}>
                ...
                <div>
                    ...
                    <p className={styles.paragraph}>Black was used to enhance legibility and add sophistication to the overall design. Black is primarily used for all text elements to ensure optimal readability; while also serving as the colour for most icons, conveying a sense of clarity and visual hierarchy.</p>
