...
export default function Colours() {
    return (
        <>
            ...
            <Image
                    src={blueContrast} alt="black on blue background" width={250} height={165}/>
                     <Image
                    src={boneContrast} alt="black on bone background" width={250} height={165}/>
                      <Image
                    src={lightGreenContrast} alt="black on light green background" width={250} height={165}/>
            </div>
        </>
    )
}