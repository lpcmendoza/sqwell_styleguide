        ...
        <>
            ...
            <div className={styles.descriptionContainer}>
                ...
                <div>
                    ...
                    <p className={styles.paragraph}>Black was used to ensure legibility, optimal contrast, and add sophistication to the overall design. Black is primarily used for all text elements to ensure optimize readability; while also serving as the colour for most icons, conveying a sense of clarity and visual hierarchy.</p>
