...
export default function Typography() {
    return (
        <main lassName={styles.typography}>
        <h2 className={styles.sectionHead}>Typography</h2>
            <div className={styles.rationale}>
                ...
                <br></br>
                <p>In contrast, Nunito serves as the main font family for the remaining textual content within the app. With its rounded edges, Nunito imparts a softer, more organic appearance to the text. This aesthetic choice aligns harmoniously with the Sqwell app's theme of outdoor activities in natural settings, providing users with an immersive experience that resonates with the app's purpose and atmosphere.</p>
            </div>
