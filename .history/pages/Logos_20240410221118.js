...
<div className={styles.logoVariations}>
    ...
    <h5>Clear Space</h5>
    <p>The minimum clear space around the Sqwell logo is specified at 24 pixels or approximately 0.25 inches, ensuring that the logo remains distinct and recognizable amidst surrounding elements. This space is equivalent to the width of one acorn, as depicted in the vertical logo variant.</p>
   </div>
