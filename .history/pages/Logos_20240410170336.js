...
<div className={styles.logoVariations}>
    ...
    <br></br>
    <h5>Clear Space</h5>
    The minimum clear space around Sqwell's logo is 24 pixels or around 0.25 inches. 24 pixels is the width of one acorn, as seen in the vertical logo.
    <h5>Sizing Options</h5>
    <p>The minimum size, as used within Sqwell's web app is 370 X 177px.</p>
    </div>
    </div>
    </div>
        <br></br>
