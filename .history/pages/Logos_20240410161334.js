...
<div className={styles.logoVariations}>
    ...
    <Image
        ...
        <h4 className={styles.incorrectUsageExample}>Do not Sqwish or stretch logo</h4>
    ...
    <br></br>
    <h5>Clear Space</h5>
    The minimum clear space around the logo is 24 pixels or around 0.25 inches. 24 pixels is the width of one acorn, as seen in the vertical logo.
